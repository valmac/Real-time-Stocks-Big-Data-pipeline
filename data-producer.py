...
if __name__ == '__main__':
	...
	parser.add_argument('symbol', help = 'the stopck symbol, such as AAPL')
	...
	producer.send(topic = topic, value = 'hello, stocks')

	fetch_price(producer, 'APPL')
...
## need to pay attention to live cycle; 
## ThreadPool;
## Database Connection;
## Network connection;
